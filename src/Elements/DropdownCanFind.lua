...
function Element:New(Idx, Config)
        ...
        local DropdownScrollFrame = New("ScrollingFrame", {
                ...
                -- [SEARCH FEATURE] Dịch xuống dưới để chừa chỗ cho thanh tìm kiếm
        ...
        -- [SEARCH FEATURE] Tạo thanh tìm kiếm
        local SearchInputRef = New("TextBox", {
                ...
                BackgroundTransparency = 1,
                TextXAlignment = Enum.TextXAlignment.Left,
                ClearTextOnFocus = false, -- Không xóa chữ khi nhấn vào
        ...
        local DropdownHolderFrame = New("Frame", {
                ...
                -- [SEARCH FEATURE] Thêm thanh tìm kiếm vào khung
                SearchBarFrame,
                DropdownScrollFrame,
                New("UICorner", {
        ...
        local ListSizeX = 0
        -- [SEARCH FEATURE] Sửa lại logic tính chiều cao để khung co giãn khi không có kết quả tìm kiếm
        local function RecalculateListSize()
                local contentHeight = DropdownListLayout.AbsoluteContentSize.Y
                -- Chiều cao tối đa 392, tối thiểu 40 (để hiện thanh tìm kiếm)
        ...
        -- [SEARCH FEATURE] Thêm sự kiện khi gõ phím
        SearchInputRef.Changed:Connect(function()
        ...
        function Dropdown:BuildDropdownList()
                local Values = Dropdown.Values
                local Buttons = {}
                -- [SEARCH FEATURE] Lấy nội dung từ thanh tìm kiếm
                ...
                for Idx, Value in next, Values do
                        ...
                        -- [SEARCH FEATURE] Bỏ qua nếu không khớp từ khóa tìm kiếm
                        if not string.find(string.lower(tostring(Value)), SearchText) then
                                continue
                        end
